...
import { ModCard, fmt } from "@/components/qiveo/ModCard";
...
export default function GameHub() {
  ...
  if (game === false) return <div className="min-h-screen bg-transparent"><Navbar /><p className="text-warm p-10 font-mono">Game not found.</p></div>;
  if (!game) return <div className="min-h-screen bg-transparent"><Navbar /></div>;
