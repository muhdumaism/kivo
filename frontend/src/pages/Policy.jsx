      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-warm/80 leading-relaxed">
          ...
          <Section title="Accounts & Security">
            Kivo uses OAuth-only login (Google / Discord) — no passwords stored. Creators must enable 2FA to publish. Staff can revoke sessions if a linked account is compromised.
          </Section>
        </div>

        <Link to="/" className="inline-block mt-10 font-mono text-xs uppercase tracking-widest text-amber hover:underline">← Back to Kivo</Link>
      </div>
    </div>
  );
}
