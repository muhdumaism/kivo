...
export default function ModDetail() {
  ...
  if (!mod) return <div className="min-h-screen bg-charcoal"><Navbar /></div>;
    ...
    <div className="min-h-screen bg-charcoal">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        ...
        <div className="min-w-0">
          ...
          <div className="py-6">
            {tab === "Description" && <div dangerouslySetInnerHTML={{ __html: renderMarkdown(mod.description) }} />}
      ...
      <div className="space-y-3">
        {comments.length ? comments.map((c) => (
          <div key={c.id} className="flex gap-3">
            <img src={c.user_avatar} alt="" className="w-8 h-8 border border-slate-light bg-slate" />
