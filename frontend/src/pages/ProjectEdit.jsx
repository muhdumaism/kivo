...
export default function ProjectEdit() {
  ...
  if (item === false) return <div className="min-h-screen bg-ink"><Navbar /><p className="text-warm p-10">Not found.</p></div>;
  ...
  return (
    <div className="space-y-5 max-w-xl">
      ...
      <div>
        ...
        <div className="flex rounded-lg border border-plumborder overflow-hidden bg-ink"><span className="px-3 py-2.5 bg-plum2 text-lavender2/50 text-sm font-mono border-r border-plumborder">kivo.app/project/</span><span className="px-3 py-2.5 text-lavender2 text-sm font-mono">{item.slug}</span></div>
      </div>
